...
- **How to measure speed:** You can't improve what you don't measure. Lighthouse (built into Chrome DevTools) gives your app a performance score and specific recommendations. The key number is Largest Contentful Paint (LCP) — how long until the biggest visible element loads. Under 2.5 seconds is good. Over 4 seconds is poor. Run Lighthouse on your app and know your numbers.
...
- **Caching dynamic data without an invalidation strategy.** Caching your database queries makes things fast — until someone updates their data and the app shows stale information for hours. Every cached item needs a plan for when and how it gets refreshed.
...
Ready? Take the Caching & CDN Exam →
