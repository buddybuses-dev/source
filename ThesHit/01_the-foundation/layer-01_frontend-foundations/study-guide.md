...
- Never checking your app on an actual phone. It looks fine on your laptop. It's broken on mobile. Every time.
...
The best way to prepare: build something real. Pick a project — even a small one — and go through the full loop. Describe it to AI. Check what it builds. Fix the gaps. Ship it. Pay attention to every place you catch a mistake. Those catches are exactly what the exam tests.
